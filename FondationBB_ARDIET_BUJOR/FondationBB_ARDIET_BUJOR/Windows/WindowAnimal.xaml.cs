...
namespace FondationBB_ARDIET_BUJOR.Windows
{
    public partial class WindowAnimal : Window
    {
        ...
        // MODIFICATION : Le constructeur accepte maintenant les listes de statuts et d'états
        ...
        private void btnValider_Click(object sender, RoutedEventArgs e)
        {
            ...
            Brush couleurErreur = new SolidColorBrush((Color)ColorConverter.ConvertFromString("#FFCDD2"));
